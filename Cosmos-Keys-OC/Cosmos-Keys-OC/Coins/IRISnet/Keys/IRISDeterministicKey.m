...
@implementation IRISDeterministicKey

- (instancetype)initWithSeed:(NSData*)seed {
    // generate private key
    NSData *masterPriKey = [IRISDeterministicKey createMasterPrivateKey:seed forKey:[@"Bitcoin seed" dataUsingEncoding:NSUTF8StringEncoding]];
...
- (DeterministicKey*)privChild:(ChildNumber*)childNumber {
    ...
    // [3] generate IRISDeterministicKey object
    DeterministicKey *rawKey = [[IRISDeterministicKey alloc] initWithPri:ki.toDataBE Pub:nil Code:[i subdataWithRange:NSMakeRange(32, 32)]];
    return rawKey;
}
...
- (DeterministicKey*)pubChild:(ChildNumber *)childNumber {
    ...
    // [5] generate IRISDeterministicKey object
    DeterministicKey *rawKey = [[IRISDeterministicKey alloc] initWithPri:nil Pub:[NSData dataWithBytes:pub_key length:33] Code:[i subdataWithRange:NSMakeRange(32, 32)]];
    return rawKey;
}

- (id)toECKey {
    return [[IRISECKey alloc] initWithKey:privateKey Pub:publicKey];
}
