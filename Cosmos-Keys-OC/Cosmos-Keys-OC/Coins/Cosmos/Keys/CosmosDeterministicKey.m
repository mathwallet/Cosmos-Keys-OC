...
#import "CosmosDeterministicKey.h"
#import "SHAHash.h"
#include "memzero.h"
#import "secp256k1_zkp.h"
#import "Categories.h"
#import "CosmosECKey.h"
#import "secp256k1.h"

@implementation CosmosDeterministicKey

- (instancetype)initWithSeed:(NSData*)seed {
    // generate private key
    NSData *masterPriKey = [CosmosDeterministicKey createMasterPrivateKey:seed forKey:[@"Bitcoin seed" dataUsingEncoding:NSUTF8StringEncoding]];
...
- (DeterministicKey*)privChild:(ChildNumber*)childNumber {
    ...
    // [3] generate CosmosDeterministicKey object
    DeterministicKey *rawKey = [[CosmosDeterministicKey alloc] initWithPri:ki.toDataBE Pub:nil Code:[i subdataWithRange:NSMakeRange(32, 32)]];
    return rawKey;
}
...
- (DeterministicKey*)pubChild:(ChildNumber *)childNumber {
    ...
    // [5] generate CosmosDeterministicKey object
    DeterministicKey *rawKey = [[CosmosDeterministicKey alloc] initWithPri:nil Pub:[NSData dataWithBytes:pub_key length:33] Code:[i subdataWithRange:NSMakeRange(32, 32)]];
    return rawKey;
}

- (id)toECKey {
    return [[CosmosECKey alloc] initWithKey:privateKey Pub:publicKey];
}
