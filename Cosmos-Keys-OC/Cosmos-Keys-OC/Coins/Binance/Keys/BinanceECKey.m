...
-(NSData *)uncompressedPubKey{
    ...
    // create pubkey
    int res = secp256k1_ec_pubkey_create(ctx, pub, &len, priv, false);
    
    // save
    if (res == 1) {
        uncompressedPubKey = [[NSData alloc] initWithBytes:pub length:len];
    }
